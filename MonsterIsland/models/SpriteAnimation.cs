...
namespace NodeTesting.models
{
    ...
    public class SpriteAnimation : SpriteManager
    {
        ...
        /// <summary>
        /// Flips the sprite horizontally (useful for changing movement direction).
        /// </summary>
        /// <param name="flipLeft">True to flip the sprite for left movement, false for right movement.</param>
        public void FlipHorizontally(bool flipLeft)
        {
            if (flipLeft)
        ...
        /// <summary>
        /// Toggles the current flip state.
        /// </summary>
